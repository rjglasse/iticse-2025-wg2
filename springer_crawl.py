#!/usr/bin/env python3
"""
Springer RSS Feed Crawler

This tool crawls Springer RSS feeds to extract bibliographic information from academic 
papers matching specific search criteria. It handles pagination across multiple pages 
and exports results to BibTeX and CSV formats with progress tracking.
