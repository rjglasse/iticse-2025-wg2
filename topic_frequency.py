...
This tool analyzes the frequency of specific topics within BibTeX files by searching 
through titles, abstracts, keywords, and other content. It generates frequency statistics 
and creates horizontal bar charts for visual analysis of topic distributions.
...
- Creates horizontal bar charts with beautiful viridis color palette
...
Requirements:
    - Python packages: matplotlib, bibtexparser
    - Topics file (plain text, one topic per line)
    - BibTeX file with DOI information
